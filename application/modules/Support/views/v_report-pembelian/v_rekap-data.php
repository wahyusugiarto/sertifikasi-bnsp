            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Data Report Pembelian</h4>
                    </div>
                        ...
                        <div class="card-body card-dashboard">
                            ...
                            <div class="box-body">
                                ...
                                <div class="search-form" style="margin-bottom: 20px;">
                                    ...
                                    <form method="post" id="myform" action="<?= base_url('export-pembelian'); ?>">
...
<script>
    ...
    function reloadTable() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('ajax-report-pembelian') ?>",
                "type": "POST",
                data: {
