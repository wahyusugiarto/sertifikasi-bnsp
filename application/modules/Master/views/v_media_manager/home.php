        ...
        <div class="card-content">
         <div class="card-body card-dashboard">
          <div class="table-responsive">
            <?php if ($accessAdd > 0) { ?>
              <a class="klik ajaxify" href="<?php echo site_url('add-tes'); ?>"><button class="btn btn-primary mb-2"><i class="feather icon-plus"></i>&nbsp; Add Data</button></a>
            <?php } ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo site_url('Master/Media_manager/LoadTes')?>",
          "type": "POST"
