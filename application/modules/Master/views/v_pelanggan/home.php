        ...
        <div class="card-content">
          <div class="card-body card-dashboard">
            <div class="table-responsive">
              <?php if ($accessAdd > 0) { ?>
                <a class="klik ajaxify" href="<?php echo site_url('add-pelanggan'); ?>"><button class="btn btn-icon btn-primary mb-2"><i class="feather icon-plus"></i>&nbsp; Add Pelanggan</button></a>
              <?php } ?>
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (result.status == true) {
              $("tr[data-id='" + id_pelanggan + "']").fadeOut("fast", function() {
                $(this).remove();
              });
