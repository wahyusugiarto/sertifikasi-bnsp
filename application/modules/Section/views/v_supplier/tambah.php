                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="supplier" placeholder="Supplier" name="supplier" aria-describedby="sizing-addon2">
                      </div>
                    </div>
  ...
  $('#form-tambah').submit(function(e) {
    ...
    if (error == 0) {
      if (supplier.length == 0) {
        error++;
        message = "nama supplier harus di isi.";
      }
    }
    ...
    if (error == 0) {
      swal({
        ...
        $.ajax({
          ...
          url: '<?php echo site_url('Section/Supplier/prosesTambah'); ?>',
          type: "post",
          data: data,
          processData: false,
          contentType: false,
