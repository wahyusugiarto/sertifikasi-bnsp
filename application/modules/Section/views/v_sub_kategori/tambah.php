    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-header">
          <h4 class="card-title">Add Data Sub Kategori Barang</h4>
        </div>
        <hr>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" id="sub_kategori" placeholder="Nama Produk" name="sub_kategori" aria-describedby="sizing-addon2">
                      </div>
                    </div>
    ...
    if (error == 0) {
      swal({
        ...
        $.ajax({
          ...
          url: '<?php echo site_url('Section/Sub_kategori/prosesTambah'); ?>',
          type: "post",
          data: data,
          processData: false,
          contentType: false,
